          ...
          <div className="card card-plain">
            <div className="header">
              ...
              <p className="category">
                A beautiful plugin, that replace the classic alert. Please check
                out the{" "}
                <a
                  href="https://github.com/chentsulin/sweetalert-react"
                  target="_blank"
                  ...
                  <div className="col-md-3">
                    <div className="card">
                      <div className="content text-center">
                        ...
                        <button
                          className="btn btn-default btn-fill"
                          onClick={() => this.setState({ message3: true })}
                        >
                          Try me!
                        </button>
                        <Alert
                  ...
                  <div className="col-md-3">
                    <div className="card">
                      <div className="content text-center">
                        ...
                        <button
                          className="btn btn-default btn-fill"
                          onClick={() => this.setState({ message5: true })}
                        >
                          Try me!
                        </button>
                        <Alert
                  ...
                  <div className="col-md-3">
                    <div className="card">
                      <div className="content text-center">
                        ...
                        <button
                          className="btn btn-default btn-fill"
                          onClick={() => this.setState({ message6: true })}
                        >
                          Try me!
                        </button>
                        <Alert
                          ...
                          showCancelButton
                          onConfirm={() =>
                            this.setState({ showMessage6SuccessDialog: true })
                          }
                          onCancel={() =>
                            this.setState({ showMessage6CancelAlert: true })
                          }
                        />
                        ...
                        <Alert
                          ...
                          type="success"
                          onConfirm={() =>
                            this.setState({ showMessage6SuccessDialog: false })
                          }
                        />
                        ...
                        <Alert
                          ...
                          type="error"
                          onConfirm={() =>
                            this.setState({ showMessage6CancelAlert: false })
                          }
                        />
                      </div>
                    </div>
                  ...
                  <div className="col-md-3">
                    <div className="card">
                      <div className="content text-center">
                        ...
                        <button
                          className="btn btn-default btn-fill"
                          onClick={() => this.setState({ message8: true })}
                        >
                          Try me!
                        </button>
                        <Alert
                        ...
                        <Alert
                          ...
                          onConfirm={() =>
                            this.setState({ showMessage8InputAlert: false })
                          }
                        />
                      </div>
                    </div>
